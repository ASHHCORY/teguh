...
if (count($_POST) > 0) {
    ...
    $itprice = $_POST['item_price'];
    $query = oci_parse($dbconn, "UPDATE ITEM SET ITEM_NAME = '$itname', ITEM_QUANTITY='$itquantity', ITEM_PRICE='$itprice'  WHERE ITEM_CODE=$itcode");
                        ...
                        <form method="post" action="" class="clearfix">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="item_price" value="<?php echo $row['ITEM_PRICE']; ?>">
                                </div>
                            </div>
                            <button type="submit" name="submit" value="submit" class=" btn btn-danger">Update Product Details</button>
                            <input type="text" name="item_code" class="txtField" value="<?php echo $row['ITEM_CODE']; ?>">
                        </form>
                    </div>
                </div>
            <?php
